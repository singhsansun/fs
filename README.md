...
If you want them, but you don't receive them, make sure that checkbox is checked, that the update URL is set to

    https://raw.githubusercontent.com/singhsansun/fs/master/fs_online_sources.user.js
